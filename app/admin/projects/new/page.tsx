...
export default function NewProjectPage() {
  ...
  const [tech, setTech] = useState<string[]>(['React', 'Next.js', 'Tailwind']);
    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        ...
        <div className="flex items-center gap-3">
          <Link href="/admin/projects" className="px-4 py-2 text-sm font-medium text-gray-400 hover:text-white transition-colors">
            Discard
          </Link>
          <button
          ...
          >
            ...
            {success ? 'Project Published!' : 'Publish Project'}
          </button>
        </div>
      </div>
